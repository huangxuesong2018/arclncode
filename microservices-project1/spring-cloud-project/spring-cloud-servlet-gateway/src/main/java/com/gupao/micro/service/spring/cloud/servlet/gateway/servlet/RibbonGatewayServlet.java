package com.gupao.micro.service.spring.cloud.servlet.gateway.servlet;
...
public class RibbonGatewayServlet extends HttpServlet {
    @Autowired
    ZookeeperLoadBalancer zookeeperLoadBalancer;

    private Server chooseServer(String serverName){
        return zookeeperLoadBalancer.chooseServer(serverName);
    }
    ...
    private String buildTargetURL(Server server, String serviceURI, HttpServletRequest request) {
        ...
        System.out.println("请求地址："+ urlBuilder.toString());
